...
(define (problem grid-6)
  ...
  (:objects loc-x0-y0 loc-x0-y1 loc-x0-y2 loc-x0-y3 loc-x0-y4 loc-x0-y5 loc-x1-y0 loc-x1-y1 loc-x1-y2 loc-x1-y3 loc-x1-y4 loc-x1-y5 loc-x2-y0 loc-x2-y1 loc-x2-y2 loc-x2-y3 loc-x2-y4 loc-x2-y5 loc-x3-y0 loc-x3-y1 loc-x3-y2 loc-x3-y3 loc-x3-y4 loc-x3-y5 loc-x4-y0 loc-x4-y1 loc-x4-y2 loc-x4-y3 loc-x4-y4 loc-x4-y5 loc-x5-y0 loc-x5-y1 loc-x5-y2 loc-x5-y3 loc-x5-y4 loc-x5-y5)
  (:init
    (at-robot loc-x3-y3)
    (visited loc-x3-y3)
