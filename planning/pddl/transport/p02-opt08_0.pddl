...
(define (problem transport-city-sequential-6nodes-1000size-2degree-100mindistance-2trucks-3packages-2008seed)
  (:domain transport)
  (:objects city-loc-1 city-loc-2 city-loc-3 city-loc-4 city-loc-5 city-loc-6 truck-1 truck-2 package-1 package-2 package-3 capacity-0 capacity-1 capacity-2 capacity-3 capacity-4)
  (:init
