...
(define (problem transport-city-sequential-21nodes-1000size-4degree-100mindistance-3trucks-8packages-2008seed)
  (:domain transport)
  (:objects city-loc-1 city-loc-2 city-loc-3 city-loc-4 city-loc-5 city-loc-6 city-loc-7 city-loc-8 city-loc-9 city-loc-10 city-loc-11 city-loc-12 city-loc-13 city-loc-14 city-loc-15 city-loc-16 city-loc-17 city-loc-18 city-loc-19 city-loc-20 city-loc-21 truck-1 truck-2 truck-3 package-1 package-2 package-3 package-4 package-5 package-6 package-7 package-8 capacity-0 capacity-1 capacity-2 capacity-3 capacity-4)
  (:init
