...
(define (problem transport-three-cities-sequential-4nodes-1000size-2degree-100mindistance-2trucks-5packages-2008seed)
  (:domain transport)
  (:objects city-1-loc-1 city-2-loc-1 city-3-loc-1 city-1-loc-2 city-2-loc-2 city-3-loc-2 city-1-loc-3 city-2-loc-3 city-3-loc-3 city-1-loc-4 city-2-loc-4 city-3-loc-4 truck-1 truck-2 package-1 package-2 package-3 package-4 package-5 capacity-0 capacity-1 capacity-2 capacity-3 capacity-4)
  (:init
