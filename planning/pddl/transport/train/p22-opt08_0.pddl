...
(define (problem transport-three-cities-sequential-2nodes-1000size-1degree-100mindistance-2trucks-3packages-2008seed)
  (:domain transport)
  (:objects city-1-loc-1 city-2-loc-1 city-3-loc-1 city-1-loc-2 city-2-loc-2 city-3-loc-2 truck-1 truck-2 package-1 package-2 package-3 capacity-0 capacity-1 capacity-2 capacity-3 capacity-4)
  (:init
