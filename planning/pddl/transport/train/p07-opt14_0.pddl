...
(define (problem transport-two-cities-sequential-5nodes-1000size-2degree-100mindistance-2trucks-4packages-2014seed)
  (:domain transport)
  (:objects city-1-loc-1 city-2-loc-1 city-1-loc-2 city-2-loc-2 city-1-loc-3 city-2-loc-3 city-1-loc-4 city-2-loc-4 city-1-loc-5 city-2-loc-5 truck-1 truck-2 package-1 package-2 package-3 package-4 capacity-0 capacity-1 capacity-2 capacity-3 capacity-4)
  (:init
